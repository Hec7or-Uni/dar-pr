...
ovs-ofctl add-flow br0 in_port=1,dl_type=0x0800,actions=output:3
ovs-ofctl add-flow br0 in_port=2,dl_type=0x0800,actions=output:3
...
ovs-ofctl add-flow br0 in_port=3,dl_type=0x0800,nw_dst=192.168.10.2,actions=output:1
```
...
ovs-ofctl add-flow br0 in_port=3,dl_type=0x0800,nw_dst=192.168.10.4,actions=output:1
```
